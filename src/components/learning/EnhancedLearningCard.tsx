              ...
              {isEditing ? (
                ...
                <>
                  ...
                  <DropdownMenu onOpenChange={setIsDropdownOpen}>
                    ...
                    {onUpdate && (
                      <DropdownMenuContent align="end" className="z-[60] bg-white border border-gray-200 shadow-xl animate-in fade-in-0 zoom-in-95 duration-200 min-w-[160px]" sideOffset={8}>
                        <DropdownMenuItem 
                          onClick={(e) => {
                            e.stopPropagation();
                            handleEdit();
